...
import com.qingyun.adapter.DownLoadRecycleAdapter;
import com.qingyun.adapter.RecycleCommonAdapter;
import com.qingyun.db.GreenDaoUtils;
...
public class DownLoadFileActivity extends BaseActivity implements View.OnClickListener, DownloadListener, RecycleCommonAdapter.OnItemClickListener {
    ...
    private void initCacheData() {
        ...
        downLoadRequestDao1.setCacheFilePath(DownLoadUtils.getDownLoadDefaultPath(downLoadUrl));
        ...
        downLoadRequestDao2.setCacheFilePath(DownLoadUtils.getDownLoadDefaultPath(downLoadUrl));
        ...
        downLoadRequestDao3.setCacheFilePath(DownLoadUtils.getDownLoadDefaultPath(downLoadUrl));
