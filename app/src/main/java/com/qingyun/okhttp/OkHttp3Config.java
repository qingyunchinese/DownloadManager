...
import com.qingyun.utils.NetWorkUtils;
...
public class OkHttp3Config {
    ...
    public static Cache getDefaultCache() {
        File httpCacheDirectory = new File(QYApplication.getInstacne().getCacheDir(), HTTP_CACHE_FILENAME);
    ...
    public static final Interceptor CACHE_CONTROL_INTERCEPTOR = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtils.isConnected(QYApplication.getInstacne())) {
