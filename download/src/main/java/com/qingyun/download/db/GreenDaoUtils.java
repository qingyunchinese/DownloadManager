package com.qingyun.download.db;


import android.database.sqlite.SQLiteDatabase;

import com.qingyun.download.DaoMaster;
import com.qingyun.download.DaoSession;
import com.qingyun.download.DownLoadRequestDao;
import com.qingyun.download.DownLoadRequestDaoDao;
...
public class GreenDaoUtils {
    ...
    private void initGreenDao() {
        devOpenHelper = new DaoMaster.DevOpenHelper(QYDownLoadManager.getInstance().getContext(), "QingYunDB", null);
