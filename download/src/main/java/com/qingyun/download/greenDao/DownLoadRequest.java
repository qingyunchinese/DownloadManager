...
*/
public class DownLoadRequest extends AbstractDao<com.qingyun.download.DownLoadRequestDao, Long> {
    ...
    public DownLoadRequest(DaoConfig config) {
        super(config);
    }
    
    public DownLoadRequest(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, com.qingyun.download.DownLoadRequestDao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, com.qingyun.download.DownLoadRequestDao entity) {
        stmt.clearBindings();
    ...
    @Override
    public com.qingyun.download.DownLoadRequestDao readEntity(Cursor cursor, int offset) {
        com.qingyun.download.DownLoadRequestDao entity = new com.qingyun.download.DownLoadRequestDao();
        readEntity(cursor, entity, offset);
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, com.qingyun.download.DownLoadRequestDao entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(com.qingyun.download.DownLoadRequestDao entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(com.qingyun.download.DownLoadRequestDao entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(com.qingyun.download.DownLoadRequestDao entity) {
